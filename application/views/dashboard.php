...
<div class="tm-container">
  <h3 class="tm-mt-3">The Impacts of the Implementation of Port Waste Management SOP for One Year</h1>
    <center>
        <img style="width:50% !importment; " src="<?php echo base_url() ?>assets/images/benner.png" class="responsive-logo" alt="Responsive image">
        </center>
  </div>
